...
internal sealed class  DefaultWebApplicationDataStructures : WebApplicationDataStructures
{
    ...
    */
    ...
    private readonly List<List<string>> ApplicationServer211Tooltips = new List<List<string>>
    {
        ...
        new List<string> {"Max-Allowed-Content-Length-Tooltip",""},
    ...
    private readonly List<List<string>> ElectronicPlanReview211Tooltips = new List<List<string>>
    {
        ...
        new List<string> {"Stylesheet-Directory-Location-Tooltip",""},
        new List<string> {"Allow-Sign-On-Tooltip",""},
        new List<string> {"Allow-Sign-Off-Tooltip",""},
        new List<string> {"Default-User-Time-Zone-Tooltip",""},
        new List<string> {"Search-Start-Year-Tooltip",""},
        new List<string> {"Items-Per-Page-Tooltip",""},
        new List<string> {"Max-Lookup-Results-Tooltip",""},
        new List<string> {"Reset-Password-Link-Lifetime-Tooltip",""},
        new List<string> {"File-Upload-Directory-Tooltip",""},
        new List<string> {"File-Upload-Validator-Tooltip",""},
        new List<string> {"Token-Authentication-Tooltip",""},
        new List<string> {"Allow-Single-Sign-On-Tooltip",""},
        new List<string> {"Source-ID-Tooltip",""},
        new List<string> {"Resolution-Mode-Tooltip",""},
        new List<string> {"Public-CAPTCHA-Key-Tooltip",""},
        new List<string> {"Private-CAPTCHA-Key-Tooltip",""},
        new List<string> {"Password-Strength-Pattern-Tooltip",""},
        new List<string> {"Password-Strength-Message-Tooltip",""},
        new List<string> {"Username-Validation-Pattern-Tooltip",""},
        new List<string> {"Discipline-Items-Per-Menu-Tooltip",""},
        new List<string> {"HTTP-Runtime-Maximum-Request-Length-Tooltip",""},
        new List<string> {"Max-Allowed-Content-Length-Tooltip",""},
        new List<string> {"EPR-Username-Tooltip",""},
        new List<string> {"EPR-Password-Tooltip",""},
        new List<string> {"Data-Source-Tooltip",""},
        new List<string> {"Encrypt-Electronic-Plan-Review-Tooltip",""}
    };
    ...
    private readonly List<List<string>> HealthcareFormManager211Tooltips = new List<List<string>>
    {
        ...
        new List<string> {"Service-Client-Type-Tooltip",""},
        new List<string> {"Stream-Settings-Tooltip",""},
        new List<string> {"Tracing-Info-Level-Tooltip",""},
        new List<string> {"Allowed-Domain-Tooltip",""},
        new List<string> {"Virtual-Directory-Tooltip",""},
        new List<string> {"Data-Source-Tooltip",""},
        ...
        new List<string> {"Default-Login-Tooltip",""},
        ...
        new List<string> {"HTTP-Runtime-Maximum-Request-Length-Tooltip",""},
        new List<string> {"HTTP-Runtime-Execution-Timeout-Tooltip",""},
        new List<string> {"Session-Timeout-Tooltip",""},
        new List<string> {"Samesite-Cookie-Policy-Tooltip",""},
        new List<string> {"Validate-Against-Checksum-Tooltip",""},
        new List<string> {"Checksum-Key-Tooltip",""},
        new List<string> {"Enable-Legacy-Checksum-Fallback-Tooltip",""},
        new List<string> {"Encrypt-Healthcare-Pop-Integration-Configuration-Tooltip",""}
    };
    ...
    private readonly List<List<string>> PatientWindow211Tooltips = new List<List<string>>
    {
        ...
        new List<string> {"Preview-Maximum-Width-Tooltip",""},
        new List<string> {"Preview-Maximum-Height-Tooltip",""},
        new List<string> {"Allow-Insecure-Connections-Tooltip",""},
        new List<string> {"Prevent-Viewer-Client-Caching-Tooltip",""},
